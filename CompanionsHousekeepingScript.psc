...
; 	Debug.Trace("CSQ: Swapping followers.")
	...
	;;; example: QF_C01_0006E803
	;Larsepan - UMF 1.5.3 changed this to no longer drop a follower.
	;If the player wants to drop one or all UMF followers, let them decide.
	;;;
	...
	;Originally sets playerfollowercount to one
EndFunction

Function CleanupFollowerState()
		;Originally sets playerfollowercount to zero
EndFunction
